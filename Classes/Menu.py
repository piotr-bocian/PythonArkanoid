...
class Menu():
    ...
    def draw_cursor(self,screen):
        points1 = [(self.cursor_center[0]+50, self.cursor_center[1]), (self.cursor_center[0]+80, self.cursor_center[1]),
                   (self.cursor_center[0]+60, self.cursor_center[1]-10)]
        points2 = [(self.cursor_center[0]+50, self.cursor_center[1]), (self.cursor_center[0]+80, self.cursor_center[1]),
                   (self.cursor_center[0]+60, self.cursor_center[1]+10)]
